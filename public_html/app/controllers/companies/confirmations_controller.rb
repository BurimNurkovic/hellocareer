class Companies::ConfirmationsController < Devise::ConfirmationsController
  def show
    ...
    # self.resource = Company.find_by_confirmation_token Devise.token_generator.
    #   digest(self, :confirmation_token, @original_token)

    self.resource = Company.find_by_confirmation_token @original_token
  ...
  def confirm
    ...
    # self.resource = Company.find_by_confirmation_token! digested_token
    self.resource = Company.find_by_confirmation_token! @original_token
